...
module _ {C : SCwF ℓC ℓC' ℓT ℓT'}{D : SCwF ℓD ℓD' ℓS ℓS'}
  ...
  reindex .snd .snd .fst Aᴰ = Presheafᴰ.reindReindex (F .snd .snd) (Dᴰ .snd .snd .fst Aᴰ)
  ...
  reindex .snd .snd .snd .snd .snd .snd Aᴰ = isFibrationReindReindex (F .snd .snd) (Dᴰ .snd .snd .snd .snd .snd .snd Aᴰ)
