...
interpTy : ∀ {Σ₀ : Sig₀ ℓ}{S : CTStructure ℓb ℓb' ℓt} → Interp₀ Σ₀ S → SimpleTy Σ₀ → S .Ty
interpTy i = i

interpCtx : ∀ {Σ₀ : Sig₀ ℓ}{S : CTStructure ℓb ℓb' ℓt} → Interp₀ Σ₀ S → Ctx (SimpleTy Σ₀) → S .B .cat .ob
interpCtx {S = S} i Γ = prod-ob (S .B) (varFinSet Γ) (λ x → sole S (i (Γ .el x)))

Interp₁ : ∀ {Σ₀ : Sig₀ ℓ}{S : CTStructure ℓb ℓb' ℓt} → Interp₀ Σ₀ S → Sig₁ Σ₀ ℓ' → Type _
Interp₁ {Σ₀ = Σ₀}{S = S} i Σ₁ =
  ∀ (f : Σ₁ .fun-symbol)
  → S .B .cat [ interpCtx {Σ₀ = Σ₀}{S = S} i (Σ₁ .src f) , S .sole (interpTy {Σ₀ = Σ₀}{S = S} i (Σ₁ .tgt f)) ]
